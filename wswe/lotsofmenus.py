...
restaurant1 = Restaurant(name="Urban Burger", description="All your meat-on-a-bun needs in the heart of the city. Vegetarian options available.")
...
restaurant2 = Restaurant(name="Super Stir Fry", description="Wok on the wild side.")
...
restaurant1 = Restaurant(name="Panda Garden", description="All your Asian favorites. Extra MSG available upon request.")
...
restaurant1 = Restaurant(name="Thyme for That Vegetarian Cuisine", description="Crunchier than you.")
...
restaurant1 = Restaurant(name="Tony\'s Bistro", description="Home-cooked Italian dishes, just the way you like them. The chef will respond to 'Hey! Tony!'")
...
# Menu for Andala's
restaurant1 = Restaurant(name="Andala\'s", description="Come on in and curry favor with that new SO. Heh heh.")
...
restaurant1 = Restaurant(name="Auntie Ann\'s Diner", description="Don\'t look here for anything fancy. Ask for the special.")
...
restaurant1 = Restaurant(name="Cocina Y Amor", description="Try our south-of-the-border specialties that will shake your maracas. Ariba!")
...
restaurant1 = Restaurant(name="State Bird Provisions", description="We specialize in endangered species. Grilled. On toast points.")
session.add(restaurant1)
session.commit()
